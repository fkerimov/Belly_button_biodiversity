...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // D3; Step 1. Create a variable that filters the metadata array for the object with the desired sample number.
    ...
    // D3; Step 2. Create a variable that holds the first sample in the metadata array.
    ...
    // D3; Step 3. Create a variable that holds the washing frequency.
